...
class TrajectoryTest():
    def __init__(self):
        ...
        self.waypoints = [{'position': Point(0, 0, 1), 'orientation': Vector3(0, 0, 0), 'frame': 0, 'speed': 1, 'fine': 0},
                          {'position': Point(0, 0, 1), 'orientation': Vector3(0, 0, 0), 'frame': 0, 'speed': 1, 'fine': 0},
                          {'position': Point(0, 0, 1), 'orientation': Vector3(0, 0, 90), 'frame': 0, 'speed': 1, 'fine': 0},
                          {'position': Point(0, 0, 1), 'orientation': Vector3(0, 0, 90), 'frame': 0, 'speed': 1, 'fine': 0},
                          {'position': Point(0, 0.001, 1), 'orientation': Vector3(0, 0, 90), 'frame': 0, 'speed': 1, 'fine': 0},
                          {'position': Point(2, 0, 0), 'orientation': Vector3(0, 0, 0), 'frame': 1, 'speed': 1, 'fine': 0}]
