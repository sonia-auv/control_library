...
namespace control
{
    ControllerPPI::ControllerPPI(std::shared_ptr<TransferFunctionCoefficient> &transferFunctionCoefficient,  int filterOrder, const double gainP):
