...
#ifndef CONTROL_LIBRARY_SPEEEDTRAJECTORYGENERATOR_H
#define CONTROL_LIBRARY_SPEEDTRAJECTORYGENERATOR_H
...
namespace control
{
    ...
    public:
        SpeedTrajectoryGenerator(double timeStamp);
        ~SpeedTrajectoryGenerator() = default;
    ...
    private:
        ...
        double AngleYaw(Eigen::VectorXd &pose);
        ...
        Eigen::Vector4d hermiteXvalues_;    // X0, X1, X0", X1"
        Eigen::Vector4d hermiteYvalues_;    // Y0, Y1, Y0", Y1"
...
#endif //CONTROL_LIBRARY_SPEEDTRAJECTORYGENERATOR_H
