...
// Conversions between SL_Bus_proc_control_node_std_msgs_Int8MultiArray and std_msgs::Int8MultiArray

void convertFromBus(std_msgs::Int8MultiArray* msgPtr, SL_Bus_proc_control_node_std_msgs_Int8MultiArray const* busPtr)
{
...
void convertToBus(SL_Bus_proc_control_node_std_msgs_Int8MultiArray* busPtr, std_msgs::Int8MultiArray const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Int8MultiArray");
