...
// Generated 07-Aug-2021 17:14:21
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
...

        {
          ...
          rtExtModeWaitForStartPkt(proc_control_node_M->extModeInfo, 6,
            &rtmStopReq);
          if (rtmStopReq) {
    ...
    void NodeInterface::baseRateTask(void)
    {
      ...
      while (mRunModel) {
        ...
        {
          boolean_T rtmStopReq = false;
          rtExtModePauseIfNeeded(proc_control_node_M->extModeInfo, 6,
            &rtmStopReq);
          if (rtmStopReq) {
            rtmSetStopRequested(proc_control_node_M, true);
          }
    ...
    void NodeInterface::extmodeBackgroundTask(void)
    {
      while (mRunModel) {
        ...
        {
          boolean_T rtmStopReq = false;
          rtExtModeOneStep(proc_control_node_M->extModeInfo, 6,
                           &rtmStopReq);
          if (rtmStopReq) {
            rtmSetStopRequested(proc_control_node_M, true);
          }
