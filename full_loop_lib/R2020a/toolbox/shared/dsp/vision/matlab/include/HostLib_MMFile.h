 ...
 *******************************/
typedef void* (*pFnLibCreate_FromMMFile)(char * err,
                                         char * warn,
                                         const void *  fileName,
                                         unsigned int  fromCG,
...
typedef void (*pFnLibOutputs_FromMMFile)(void *hl,
                                         char *err,
                                         unsigned char *bDone,
                                         void *audio,
                                         void *R,
...
typedef void* (*pFnLibCreate_ToMMFile)(char * err,
                                       char * warn,
                                       const void *  fileName,
                                       unsigned int  fromCG,
                                       MMFileType    fileType,
...
typedef void (*pFnLibUpdate_ToMMFile)(void * hl,
                                      char * err,
                                      const void * audio,
                                      const void * R,
                                      const void * G,
