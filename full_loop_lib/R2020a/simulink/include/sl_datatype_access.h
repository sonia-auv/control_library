...
typedef size_t (*ContainedDataNumDimsFcn) (const void *);
typedef ContainedDataNumDimsFcn (*GetContainedDataNumDimsFcn) (void *, DTypeId);
typedef int_T (*SetContainedDataNumDimsFcn) (void *, DTypeId, ContainedDataNumDimsFcn);

typedef DTypeId (*ContainedDataTypeFcn) (const void *);
typedef ContainedDataTypeFcn (*GetContainedDataTypeFcn) (void *, DTypeId);
typedef int_T (*SetContainedDataTypeFcn) (void *, DTypeId, ContainedDataTypeFcn);
...
struct _slDataTypeAccess_tag {
    ...
    GetContainedDataNumDimsFcn  getContainedDataNumDimsFcn;
    SetContainedDataNumDimsFcn  setContainedDataNumDimsFcn;

    GetContainedDataTypeFcn  getContainedDataTypeFcn;
    SetContainedDataTypeFcn  setContainedDataTypeFcn;
